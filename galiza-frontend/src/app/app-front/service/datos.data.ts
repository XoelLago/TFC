...
export const MAP_DATA: DatosMapa[] = [
  {
    ...
    cancions: ['Alalá do Cebreiro'],
    eventos: ['Festas do Apóstolo', 'Ascensión'],
  },
  {
    _id: "2",
    nome: 'Asociación O Fiadeiro',
    ...
    cancions: ['Cantigas de Mar'],
    eventos: ['Certame de Baile Tradicional'],
  },
  {
    _id: "3",
    nome: 'Entroido de Laza',
